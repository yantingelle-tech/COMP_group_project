# COMP2090SEF Task 1: Intelligent Wardrobe Management and Outfit Recommendation System OVERALL SUMMARY
⚠️This "README" is a comprehensive summary of the two tasks in the COMP2090SEF assignment, covering usage instructions, module explanations, code principles, etc. The "USER GUIDE" is located in the task1 and task2 folders respectively.
...
Link of Introduction Video: https://drive.google.com/file/d/1TJlngILNVI3SD0ejGv7LWRi4ZQkpHQWg/view?usp=sharing         
---
## Contents
...
# COMP2090SEF Task 2: Graph Data Structure & Dijkstra's Algorithm OVERALL SUMMARY            

## Project Overview

The COMP2090SEF course Task 2, mainly demonstrating the self-study and application of a new data structure (Graph) and a new algorithm (Dijkstra's Algorithm) that were not covered in class.Our task two calculates the shortest path between cities using Dijkstra's algorithm by building a weighted undirected graph.         
