...
*   **`SearchClothes.py` / `SelectClothes.py` / `ReviewClothes.py`**  
    Browsing and retrieval collaboration modules. Respectively responsible for: capturing user search keywords [10], accurately matching target clothing items based on keywords [11], and formatting and printing the search results to the user.
